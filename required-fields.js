...
(function (root, factory) {
    ...
    const EXPERT_FIELDS = [
        ...
        { name: 'bauart_innenwand_eg',         label: 'Innenwände EG–DG',                section: 'bauart', type: 'radio' },
        { name: 'bauart_innenwand_ug',         label: 'Innenwände UG',                   section: 'bauart', type: 'radio' },
        { name: 'bauart_innenwand_dicke_tragend',       label: 'Innenwand-Stärke tragend',       section: 'bauart', type: 'radio' },
        { name: 'bauart_innenwand_dicke_nichttragend',  label: 'Innenwand-Stärke nichttragend',  section: 'bauart', type: 'radio' },
